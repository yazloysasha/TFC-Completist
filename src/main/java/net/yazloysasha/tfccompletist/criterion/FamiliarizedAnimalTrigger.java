...
public final class FamiliarizedAnimalTrigger
  extends SimpleCriterionTrigger<FamiliarizedAnimalTrigger.TriggerInstance> {
  ...
  public record TriggerInstance(
    ...
    public boolean matches(ResourceLocation familiarizedEntityId) {
      return entity.isEmpty() || entity.get().equals(familiarizedEntityId);
    }
  }
}

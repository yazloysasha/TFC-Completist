 ...
 * <p>
 * Every discoverable still fluid in {@code #tfc:alcohols} (TFC base plus
 * addons such as Firmalife, which extend that tag). Drinking is tracked through TFC's {@code Drinkable}
...
public final class SommelierAdvancementPatch {
  ...
  public static void patch(
    ...
    FluidCollectionAdvancementPatch.patchDrinkFromTags(
      ...
      resourceManager,
      registries,
      List.of(TFCTags.Fluids.ALCOHOLS)
    );
  }
}
